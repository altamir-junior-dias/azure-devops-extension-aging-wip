(() => {
        ...
        appendScript('lib/chart.min.js').onload = () => {
            appendScript('lib/VSS.SDK.min.js').onload = () => {
                ...
                VSS.require([
                    ...
                    widgetFile + '.js'
                ], function (WidgetHelpers, VSSService, TFSWorkItemTrackingRestClient, TFSWorkRestClient, TFSCoreRestClient, ChartsService) {
                    VSS.getService(VSS.ServiceIds.ExtensionData).then(dataService => {
                        window.AzureDevOpsProxy.init(VSSService, TFSWorkItemTrackingRestClient, TFSWorkRestClient, TFSCoreRestClient, dataService);
    ...
    window.initializeWidgetConfiguration = (widgetConfigurationName, widgetConfigurationFile) => {
        appendScript('lib/VSS.SDK.min.js').onload = () => {
            ...
            ], (WidgetHelpers, VSSService, TFSWorkItemTrackingRestClient, TFSWorkRestClient, TFSCoreRestClient) => {
                WidgetHelpers.IncludeWidgetConfigurationStyles();

                VSS.register(widgetConfigurationName, () => {
                    window.AzureDevOpsProxy.init(VSSService, TFSWorkItemTrackingRestClient, TFSWorkRestClient, TFSCoreRestClient);
